        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Taxpayer`s Information</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
							<a href="taxpayer_reg_form.php" style="background:none;">
							<button class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Add Taxpayer</button>
							</a>
							</li>
                            <li>
							<a href="import_members.php" style="background:none;">
							<button class="btn btn-success btn-outline"><i class="fa fa-upload"></i> Import Taxpayer</button>
							</a>
							</li>
                        <!---    <li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($conn,"select * from user order by user_id DESC") or die (mysqli_error($conn));
