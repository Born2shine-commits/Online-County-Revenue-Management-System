...
$row=mysqli_fetch_array($query);
  ?>
                            ...
                            <form method="post" action="savepayment.php" class="form-horizontal form-label-left">
                       <div class="form-group">
                                    <label class="control-label col-md-4" >Business Name
                                    </label>
                                    <div class="col-md-3">
                                        <input type="text"required="required" value="<?php echo $row['business_name']; ?>" name="business_name"  class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text"required="required" name="business_type" value="<?php echo $row['business_type']; ?>" placeholder="MI / Middle Name....." class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text"required="required" value="<?php echo $row['address']; ?>" name="address" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type='text'required='required' value="<?php echo $row['location']; ?>"  name="blocation" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                              <div class="form-group">
                              ...
                              <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <a href="taxpayer_form.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Cancel</button></a>
