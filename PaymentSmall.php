  ...
  ?>
                       ...
                       <div class="form-group">
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type='text' value="500" name="amount" readonly="readonly" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                              ...
                              <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <a href="small_business.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Cancel</button></a>
                                        <button type="submit" name="save" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> SAVE</button>
<!-- 										<a href="smallprint.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Print</button></a>
 -->                                    </div>
                                </div>
                            </form>
