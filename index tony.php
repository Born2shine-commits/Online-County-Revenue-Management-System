...
<body style="background:#F7F7F7;">
    ...
    <div class="">
         <!-- <h1><i class="fa fa-university" style="font-size: 26px;"></i> County Revenue Collection Management System</h1> -->
        <div id="wrapper">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="separator">
                            ...
                            <div>
                                ...
                                <p>© <?php echo date('Y'); ?> <i class="fa fa-book"></i> wycliffe odhiambo</p>
                            </div>
                        </div>
                    </form>
<?php
