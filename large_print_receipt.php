            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <!--        <li>
						...
						-->
                            <li>
							<a href="report_printlarge1.php" target="_blank" style="background:none;">
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr>
								...
								<td><a href="receipt_large.php?business_name=<?php echo $row['business_name']?>">print RECEIPT</td>
							</tr>
							<?php } ?>
							</tbody>
							</table>
