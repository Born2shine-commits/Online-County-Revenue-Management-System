...
$row=mysqli_fetch_array($query);
  ?>
                            ...
                            <form method="post" action="savepayment2.php" class="form-horizontal form-label-left">
                              ...
                              <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <a href="market.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Cancel</button></a>										 
                                        <button type="submit" name="save" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> SAVE</button>
<!-- 										<a href="marketprint.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Print</button></a>
 -->                                    </div>
                                </div>
                            </form>
