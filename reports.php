				...
				-->
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							LEFT JOIN taxpayer ON smallpayment.payment_id = smallpayment.payment_id 
							LEFT JOIN clerk ON smallpayment.payment_id = clerk.clerk_id 
							order by smallpayment.payment_id DESC ") or die (mysqli_error($conn));
