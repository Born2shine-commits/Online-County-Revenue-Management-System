...
// 	 ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-file"></i> Receipt</h2>
                    ...
                    <!--        <li>
						...
						-->
                            <li>
							<a href="small_print_receipt.php" target="_blank" style="background:none;">
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr>
								...
								<td><a href="receipt_market.php?business_name=<?php echo $row['business_name']?>">print RECEIPT</td>
							</tr>
							<?php } ?>
							</tbody>
							</table>
