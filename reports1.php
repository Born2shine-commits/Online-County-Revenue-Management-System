            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <!--        <li>
						...
						-->
                            <li>
							<a href="report_print1.php" target="_blank" style="background:none;">
						...
						<form method="POST" action="report_search1.php" class="form-inline">
				...
				-->
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							order by report.report_id DESC ") or die (mysqli_error($conn));
