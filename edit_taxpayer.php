...
<?php include ('header2.php'); ?>
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Home / Taxpayer /</small> Edit Taxpayer
                </h3>
            </div>
        </div>
...
$query=mysqli_query($conn," UPDATE taxpayer SET business_name='$business_name', business_type='$business_type', address='$address', location='$location' WHERE id='$id'")or die(mysqli_error($conn));
if($query>0)
{
