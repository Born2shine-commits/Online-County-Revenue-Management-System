...
<?php include ('header1.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Admin / Admin Profile /</small> Edit Admin
                </h3>
            </div>
        </div>
...
$result=mysqli_query($conn,"select * from admin") or die (mysqli_error($conn));
...
{
$query=mysqli_query($conn,"UPDATE admin SET firstname='$firstname', middlename='$middlename', lastname='$lastname', username='$username', password='$password', 
...
{
	echo "<script>alert('Update Admin Info failed!'); window.location='admin.php'</script>";	
}
...
{
	echo "<script>alert('Update Admin failed!'); window.location='admin.php'</script>";
}
